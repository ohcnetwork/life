...
const HomeTabs = ({ tabVal, onChange, resources }) => {
    const resourcesListing = filterResourcesBy(resources, 'show_all');
    const noData = resourcesListing.length === 0;
    return (
        <div className="dark:text-gray-200 mx-auto max-w-xs text-base flex font-bold justify-around my-6 cursor-pointer">
            ...
            <div
                className={`w-3/6 flex justify-center items-center pb-2  ${
                    tabVal === 'twitter' || tabVal === 'twitter_on_no_data'
            ...
            <div
                className={`w-3/6 flex justify-center items-center pb-2  ${
                    tabVal === 'maps' ? `border-b-2 border-gray-900 dark:border-gray-300` : ``
                }`}
