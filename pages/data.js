                ...
                <ul className="space-y-4">
                    {formsInfo.map((form, id) => {
                        return (
                            <li
                                key={id}
                                className="group relative  rounded-lg shadow-sm cursor-pointer focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-indigo-500">
                                <div className="rounded-lg border dark:bg-gray-1200 border-gray-300 px-6 py-4 hover:border-gray-400 sm:flex sm:justify-between">
                                    ...
                                    <div className="mt-2  flex text-sm sm:mt-0 sm:block sm:ml-4 sm:text-right">
                                        <a href={form.link} target="_blank" type="button">
                                            <div className="flex items-center px-4 py-2 shadow-sm text-sm font-medium rounded-md  text-white bg-indigo-600 hover:bg-indigo-800 dark:bg-indigo-800 dark:hover:bg-indigo-600">
                                                <svg
                                                    className="mr-1"
                                                    width="20"
                                                    height="20"
