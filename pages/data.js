...
export default function DataForm() {
    ...
    return (
        <div>
            <section className="w-full max-w-sm mx-auto text-center text-2xl font-bold my-3 dark:text-gray-400">{t.question}</section>
            <section className="w-full max-w-xl mx-auto">
                <ul className="space-y-4">
                    {formsInfo.map((form, id) => {
                        return (
                            <li key={id} className="group relative bg-white rounded-lg shadow-sm cursor-pointer focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-indigo-500">
