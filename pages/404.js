...
const TextCompnent = () => {
    return (
        <div className="p-5 mx-auto">
            <div className="font-bold text-2xl md:text-4xl dark:text-gray-200">
                Oops! No data found
            </div>
    ...
    return (
        <div>
            <div className="flex items-center text-center justify-center">
                ...
                <div className="font-mono text-5xl md:text-9xl font-semibold flex items-center">
                    <h1 className="font-mono text-5xl md:text-9xl font-semibold flex items-center dark:text-gray-100">
                        4
                    </h1>
                </div>
            </div>
