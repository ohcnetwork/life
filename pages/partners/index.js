...
const partners = [
    ...
    },
    {
        ...
        name: 'Coronasafe',
        logoURL:
            'https://assets.zyrosite.com//Yyve4DOKXjcZ8bJ0/coronasafe-logo-m5KOkkg54nIzwx6x.svg',
        url: 'https://piindia.org/index-web.html'
    },
    {
        id: '6',
        ...
        logoURL:
            'https://res.cloudinary.com/glide/image/fetch/f_auto,w_150,h_150,c_lfill/https%3A%2F%2Ffirebasestorage.googleapis.com%2Fv0%2Fb%2Fglide-prod.appspot.com%2Fo%2Ficon-images%252Fanonymous-845cd98e-e571-483a-984b-daebd749be79.png%3Falt%3Dmedia%26token%3Db8da4311-19b4-49c5-868c-dc46d73b1e0f',
    ...
    },
    {
        ...
        logoURL:
            'https://static.wixstatic.com/media/7c7963_a199f541090c4734a25b732b94f1ad3a~mv2.png/v1/fill/w_135,h_79,al_c,q_85,usm_0.66_1.00_0.01/TPF_Logo.webp',
    ...
    return (
        <section className="max-w-5xl mx-auto px-2">
            ...
            <section className="py-10 dark:text-gray-500 text-gray-900 px-2 md:mx-10">
                <div className="flex justify-between items-center w-full">
                    <div className="space-y-4 w-full my-4 dark:text-white">
                        ...
                        organisation running Covid Relief Projects, ask them to join forces! Fill
                        up&nbsp;
                        <a
                            href="https://forms.gle/mipGNhsuVFXWiTGG6/"
            ...
            <section className="pb-10 dark:text-gray-500 text-gray-900  md:mx-10" id="partner">
                ...
                <div
                    className="flex flex-warp justify-stretch space-y-6 dark:text-white mt-6 w-full"
                    align="center">
