            ...
            <section className="py-10 dark:text-gray-500 text-gray-900 px-2 md:mx-10">
                <div className="flex flex-col justify-between items-center w-full">
                    ...
                    <div className="flex items-center flex-wrap justify-center w-full my-4 dark:text-white">
                        <button type="button" className="inline-flex mr-2 items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
