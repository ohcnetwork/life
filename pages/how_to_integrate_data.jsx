            ...
            <section className="dark:text-gray-300">
                ...
                <div className="flex justify-center my-2">
                    <button type="button" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        <a href="https://bit.ly/JoinForces-CovidReliefIndiaAlliance">Fill this Form</a>
                    </button>
                </div>
                <div className="mt-5 px-2">
                    Feel free to share this form with other initiatives to integrate with the alliance, in case they are doing the same thing as - database addition verification updation. It is being coordinated by Aakriti, Prajakta, Nameet, Ashish over a whatsapp group.
                    <span className="font-bold"> The first step would be to fill the form above. </span>
                    Thanks!
                </div>
            </section>
        </section>
