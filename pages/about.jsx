    ...
    return (
        <>
            ...
            <div className="py-10 dark:text-gray-500 text-gray-900 dark font-bold px-2">
                ...
                <p className={pClass}>
                    COVID Information Platform (https://liferesources.in/about) is a platform created by Swasth Digital Health Foundation (“Swasth”), CovidFYI and Coronasafe Network for providing verified crowd sourced emergency services for COVID-19 emergencies across India. 
                </p>
                <p className={pClass}>
